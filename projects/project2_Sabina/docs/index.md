...
While the original proposal included an energy harvesting system powered by the stepper motors, the final prototype concentrated on establishing a reliable kinetic platform and motion control architecture that can support future integration of self-powered lighting components.
