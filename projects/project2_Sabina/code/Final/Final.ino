...
void setup() {
  ...
  // --------------------------------------------------
  // BUTTON D1
  // This is the same style as your working button code
  // --------------------------------------------------
  ...
  Serial.println("System ready. Press D1 to toggle ON/OFF.");
}
...
void stop_all_motion() {
  ...
  // Hold B at current estimated position
